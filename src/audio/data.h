...
#define PERSISTENT_SEQ_MEM 0x5000
#define PERSISTENT_BANK_MEM 0x8600
#define TEMPORARY_SEQ_MEM 0x6000
#define TEMPORARY_BANK_MEM 0x4400
#define MAX_NUM_SOUNDBANKS 0x30
#define EXT_AUDIO_INIT_POOL_SIZE 0x400 // extra space
#endif
