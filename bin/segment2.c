...
#include "textures/segment2/segment2.a.rgba16.inc.c"
};
...
#include "textures/segment2/segment2.e.rgba16.inc.c"
};

ALIGNED8 static const Texture texture_hud_char_F[] = {
#include "textures/segment2/segment2.f.rgba16.inc.c"
};
...
#include "textures/segment2/segment2.v.rgba16.inc.c"
};
...
const Texture *const main_hud_lut[] = {
    ...
    texture_hud_char_mario_head, texture_hud_char_luigi_head, texture_hud_char_ultrabell, texture_hud_char_star,
    texture_hud_char_decimal_point, texture_hud_char_beta_key, texture_hud_char_apostrophe, texture_hud_char_double_quote,
