...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, -4096, 0, 5952, 0, -90, 0, DIALOG_003, bhvMessagePanel),
		...
		OBJECT_WITH_ACTS(MODEL_NONE, 3072, 4194, -5000, 0, 0, 0, 0x00000000, bhvKoopaRaceEndpoint, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_KOOPA_FLAG, 3072, 4194, -5000, 0, 0, 0, 0x00000000, bhvKoopaFlag, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_KOOPA_WITH_SHELL, -4096, 0, 6400, 0, 0, 0, 0x01020000, bhvKoopa, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
