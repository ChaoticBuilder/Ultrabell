...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_BOBOMB_BUDDY, -4600, 0, 5060, 0, 0, 0, DIALOG_004 << 16, bhvBobombBuddy),
		OBJECT(MODEL_BREAKABLE_BOX, -4200, 0, 5000, 0, 0, 0, DIALOG_004 << 16, bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -3600, 16, 4850, 0, 0, 0, DIALOG_004 << 16, bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -3600, 16, 5200, 0, 0, 0, DIALOG_004 << 16, bhvBreakableBox),
		OBJECT(MODEL_CHECKERBOARD_PLATFORM, -2303, 717, 1024, 0, 45, 0, 0x00140000, bhvCheckerboardElevatorGroup),
		OBJECT(MODEL_CHAIN_CHOMP, 735, 768, 1560, 0, 0, 0, 0x00000000, bhvChainChomp),
		...
		OBJECT(MODEL_STAR, 1550, 1200, 300, 0, 0, 0, 0x04000000, bhvStar),
