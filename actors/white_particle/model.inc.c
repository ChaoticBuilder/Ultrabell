...
#include "actors/white_particle/snow_particle.custom.ia16.inc.c"
};
...
const Gfx white_particle_dl[] = {
    ...
    gsDPLoadTextureBlock(white_particle_texture, G_IM_FMT_IA, G_IM_SIZ_16b, 16, 16, 0, G_TX_CLAMP, G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
