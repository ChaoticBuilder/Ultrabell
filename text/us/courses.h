COURSE_ACTS(COURSE_BOB, _("BOB-OMB'S PLAINS"),
...
COURSE_ACTS(COURSE_JRB, _("NAVY SHIP BAY"),
...
COURSE_ACTS(COURSE_BBH, _("HAUNTED BOO MANSION"),
       ...
       _("SEEK OUT THE 8 RED COINS!")     , _("BIG BOO FIGHT")                 , _("EYE TO EYE IN THE SECRET ROOM"))

COURSE_ACTS(COURSE_HMC, _("HAZY DUNGEON MINE"),
       _("ISLAND ON THE WATERS BELOW")    , _("ELEVATE FOR 8 RED COINS")       , _("METAL MARIO'S GOTTA MOVE!"),
       _("NAVIGATING THE HAZY CAVE")      , _("A-MAZE-ING EMERGENCY EXIT")     , _("WATCH FOR ROLLING ROCKS"))

COURSE_ACTS(COURSE_LLL, _("FIREBALL VOLCANO"),
       _("BOIL THE BIG BULLY")            , _("BULLY THE BULLIES")             , _("BOWSER'S 15 PUZZLE"),
       _("RED-HOT LOG ROLLING")           , _("HOT-FOOT-IT INTO THE VOLCANO")  , _("ELEVATOR TOUR IN THE VOLCANO"))

COURSE_ACTS(COURSE_SSL, _("DESERT DYSTOPIA LAND"),
...
COURSE_ACTS(COURSE_DDD, _("DIRE, DIRE DOCKS"),
...
COURSE_ACTS(COURSE_SL, _("SNOWMAN'S CHILL LAND"),
...
COURSE_ACTS(COURSE_WDW, _("SHIFTY WATER WORLD"),
...
COURSE_ACTS(COURSE_TTM, _("TALL MOUNTAIN"),
...
COURSE_ACTS(COURSE_THI, _("TINY-HUGE ISLAND"),
...
COURSE_ACTS(COURSE_TTC, _("TICK TOCK CLOCK"),
...
COURSE_ACTS(COURSE_RR, _("RAINBOW SKY"),
...
SECRET_STAR(COURSE_PSS, _("TOADSTOOL'S SLIPPERY SLIDE"))
...
SECRET_STAR(COURSE_SA, _("CASTLE AQUARIUM"))
