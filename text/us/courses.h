...
COURSE_ACTS(COURSE_LLL, _("FIREBALL INFERNO"),
...
COURSE_ACTS(COURSE_DDD, _("AQUATIC OCEAN LAND"),
...
COURSE_ACTS(COURSE_WDW, _("WATER SWITCH WORLD"),
...
COURSE_ACTS(COURSE_TTM, _("GIANT MOUNTAIN"),
...
SECRET_STAR(COURSE_PSS, _("TOADSTOOL'S SLIDE"))
