COURSE_ACTS(COURSE_BOB, _(" 1 BOB-OMB FIELD"),
       _("KING BOB-OMB'S SUMMIT")         , _("KOOPA TROOPA RACE!")            , _("FLOATING ISLAND UP ABOVE"),
       _("FIND THE 8 RED COINS!")         , _("MARIO'S AIRLINES")              , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WF, _(" 2 MOUNTAIN FORTRESS"),
...
COURSE_ACTS(COURSE_JRB, _(" 3 NAVY SHIP BAY"),
...
COURSE_ACTS(COURSE_CCM, _(" 4 SNOWY MOUNTAIN SLIDE"),
       _("CABIN SLIDING!")                , _("THAT ONE STAR EVERYBODY HATES") , _("ANNUAL PENGUIN RACE"),
       _("SLIPPERY 8 RED COINS!")         , _("SNOWMAN'S LOST HIS HEAD")       , _("MARIO WALL KICK CHALLENGE"))

COURSE_ACTS(COURSE_BBH, _(" 5 BOO'S HAUNTED MANSION"),
...
COURSE_ACTS(COURSE_HMC, _(" 6 MAZEY DUNGEON MINE"),
...
COURSE_ACTS(COURSE_LLL, _(" 7 FIRE VOLCANO LAND"),
...
COURSE_ACTS(COURSE_SSL, _(" 8 DYSTOPIAN DESERT DOMAIN"),
